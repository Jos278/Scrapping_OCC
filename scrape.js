...
export async function scrapeOCC(searchTerm) {
  ...
  // Ir a OCC y esperar a que todo cargue
  await page.goto(OCC_URL, { waitUntil: 'networkidle2' });

  // Esperar que aparezca el input de búsqueda
  await page.waitForSelector('#prof-cat-search-input-desktop', {
    visible: true,
    timeout: 30000
  });
  ...
  await Promise.all([
    ...
    page.waitForSelector('div[id^="jobcard-"]', { visible: true, timeout: 30000 })
  ]);
